...
Module Type MEMORY_ALLOCATED_HELPER (ADDR : CORE_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) := CORE_MEMORY_MODEL ADDR SB <+ MEMORY_ALLOCATED_CORE ADDR SB AID.
Module Type WRITEABLE_MEMORY_ALLOCATED_HELPER (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) := WRITEABLE_MEMORY_HELPER ADDR SB <+ MEMORY_ALLOCATED_CORE ADDR SB AID.
...
Module ALL_ALLOCATED_PRESERVED
  ...
  (Import SB : SBYTE)
  (Import AID : ALLOCATION_ID)
  (Import MEM : MEMORY_ALLOCATED_HELPER ADDR SB AID).
...
Module Type WRITES_PRESERVES_ALLOCATED
  ...
  (Import SB : SBYTE)
  (Import AID : ALLOCATION_ID)
  (Import MEM : WRITEABLE_MEMORY_ALLOCATED_HELPER ADDR SB AID).

  Include (ALL_ALLOCATED_PRESERVED ADDR SB AID MEM).
...
Module Type MEMORY_FIND_FREE_HELPER (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) := MEMORY_ALLOCATED_HELPER ADDR SB AID <+ MEMORY_FIND_FREE ADDR SB AID.
...
Module Type EXEC_SPEC_MEMORY_FIND_FREE (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) := MEMORY_FIND_FREE_HELPER ADDR SB AID <+ EXEC_MEMORY_FIND_FREE ADDR SB.

Module Type EXEC_MEMORY_FIND_FREE_CORRECT
  (Import ADDR : BASIC_ADDRESS)
  (Import SB : SBYTE)
  (Import AID : ALLOCATION_ID)
  (Import MEM : EXEC_SPEC_MEMORY_FIND_FREE ADDR SB AID).
...
Module Type MEMORY_ALLOCATE
  ...
  (Import SB : SBYTE)
  (Import AID : ALLOCATION_ID)
  (Import MEM : MEMORY_FIND_FREE_HELPER ADDR SB AID).
...
Module Type MEMORY_ALLOCATE_HELPER
  ...
  (SB : SBYTE)
  (AID : ALLOCATION_ID)
  := MEMORY_FIND_FREE_HELPER ADDR SB AID <+ MEMORY_ALLOCATE ADDR SB AID.
...
Module Type EXEC_MEMORY_ALLOCATE_CORRECT
  ...
  (Import SB : SBYTE)
  (Import AID : ALLOCATION_ID)
  (Import MEM : EXEC_SPEC_MEMORY_ALLOCATE ADDR SB AID).
...
Module ALLOCATABLE_MEMORY_TO_FULL_MEMORY_MODEL
  ...
  Definition heap_allocate_block
    (m1 : Memory) (bytes : list SByte) (aid : AllocationId) (res : (Memory * list addr)%type) : Prop
    := match res with
       | (m2, ptrs) =>
           find_free_block m1 (length bytes) ptrs /\
             (length bytes > 0 -> Forall (fun p => is_null p = false) ptrs) /\
             Forall2 (fun b ptr => read_byte m2 ptr b) bytes ptrs /\
             (forall b ptr, read_byte m1 ptr b -> read_byte m2 ptr b) /\
             Forall (fun ptr => addr_allocated m2 ptr aid) ptrs /\
             Memory_heap m2 = add_ptrs_to_heap (Memory_heap m1) ptrs
