...
Module Type CORE_EXEC_READ_MEMORY_MODEL
  (Import ADDR : CORE_ADDRESS)
  (Import SB : SBYTE)
  (Import MEM : MEMORY_MODEL_BASE ADDR SB).
  (** Primitive byte reads *)
...
Module Type CORE_EXEC_MEMORY_MODEL (ADDR : CORE_ADDRESS) (SB : SBYTE) (MEM : MEMORY_MODEL_BASE ADDR SB) := CORE_EXEC_READ_MEMORY_MODEL ADDR SB MEM.
Module Type CORE_EXEC_SPEC_MEMORY_MODEL (ADDR : CORE_ADDRESS) (SB : SBYTE) (MEM : MEMORY_MODEL_BASE ADDR SB) := CORE_MEMORY_MODEL_F ADDR SB MEM <+ CORE_EXEC_MEMORY_MODEL ADDR SB MEM.

Module Type CORE_EXEC_MEMORY_MODEL_CORRECT
  (Import ADDR : CORE_ADDRESS)
  (Import SB : SBYTE)
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import EXEC_SPEC : CORE_EXEC_SPEC_MEMORY_MODEL ADDR SB MEM).
...
Module Type MEMORY_READ_ACCESS
  ...
  (Import SB : SBYTE)
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import CORE : CORE_MEMORY_MODEL_F ADDR SB MEM).
...
Module Type READABLE_MEMORY (ADDR : CORE_ADDRESS) (SB : SBYTE) (MEM : MEMORY_MODEL_BASE ADDR SB) := CORE_MEMORY_MODEL_F ADDR SB MEM <+ MEMORY_READ_ACCESS ADDR SB MEM.
Module Type READABLE_EXEC_MEMORY (ADDR : CORE_ADDRESS) (SB : SBYTE) (MEM : MEMORY_MODEL_BASE ADDR SB) := CORE_EXEC_MEMORY_MODEL ADDR SB MEM.
Module Type READABLE_EXEC_SPEC_MEMORY (ADDR : CORE_ADDRESS) (SB : SBYTE) (MEM : MEMORY_MODEL_BASE ADDR SB) := CORE_EXEC_SPEC_MEMORY_MODEL ADDR SB MEM <+ MEMORY_READ_ACCESS ADDR SB MEM.
Module Type READABLE_CORRECT_MEMORY (ADDR : CORE_ADDRESS) (SB : SBYTE) := READABLE_EXEC_SPEC_MEMORY ADDR SB.
...
Module ALL_READ_ACCESS_PRESERVED
  ...
  (Import SB : SBYTE)
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import READ : READABLE_MEMORY ADDR SB MEM).
...
Module Type EXEC_WRITEABLE_MEMORY_HELPER (ADDR : BASIC_ADDRESS) (SB : SBYTE) (MEM : MEMORY_MODEL_BASE ADDR SB) := READABLE_EXEC_MEMORY ADDR SB MEM <+ EXEC_MEMORY_WRITES ADDR SB MEM.
Module Type EXEC_SPEC_WRITEABLE_MEMORY_HELPER (ADDR : BASIC_ADDRESS) (SB : SBYTE) (MEM : MEMORY_MODEL_BASE ADDR SB) :=
  WRITEABLE_MEMORY_HELPER ADDR SB MEM <+ EXEC_WRITEABLE_MEMORY_HELPER ADDR SB MEM.

Module Type EXEC_MEMORY_WRITES_CORRECT
  (Import ADDR : BASIC_ADDRESS)
  (Import SB : SBYTE)
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import EXEC_SPEC : EXEC_SPEC_WRITEABLE_MEMORY_HELPER ADDR SB MEM).
...
Module Type CORRECT_WRITEABLE_MEMORY_HELPER (ADDR : BASIC_ADDRESS) (SB : SBYTE) (MEM : MEMORY_MODEL_BASE ADDR SB) :=
  EXEC_SPEC_WRITEABLE_MEMORY_HELPER ADDR SB MEM <+ EXEC_MEMORY_WRITES_CORRECT ADDR SB MEM.

Module Type MEMORY_WRITE_ACCESS
  (Import ADDR : BASIC_ADDRESS)
  (Import SB : SBYTE)
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import WRITE : WRITEABLE_MEMORY_HELPER ADDR SB MEM).
...
Module ALL_WRITE_ACCESS_PRESERVED
  ...
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import WRITE : WRITEABLE_MEMORY_HELPER ADDR SB MEM)
  (Import WRITE_ACCESS : MEMORY_WRITE_ACCESS ADDR SB MEM WRITE).
...
Module Type WRITES_PRESERVES_READ_ACCESS
  ...
  Include (ALL_READ_ACCESS_PRESERVED ADDR SB MEM WRITE).
...
Module Type WRITES_PRESERVES_WRITE_ACCESS
  ...
  Include (ALL_WRITE_ACCESS_PRESERVED ADDR SB MEM WRITE WRITE_ACCESS).
...
Module Type MEMORY_MODEL_BASE_FRESH_STORE_ID (ADDR : BASIC_ADDRESS) (SB : SBYTE)
  := MEMORY_MODEL_BASE ADDR SB <+ CORE_MEMORY_FRESH_STORE_ID ADDR SB.

Module Type WRITEABLE_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (MEM : MEMORY_MODEL_BASE ADDR SB)
  := WRITEABLE_MEMORY_HELPER ADDR SB MEM <+
       MEMORY_WRITE_ACCESS ADDR SB MEM <+
       WRITES_PRESERVES_READ_ACCESS ADDR SB MEM <+
       WRITES_PRESERVES_WRITE_ACCESS ADDR SB MEM.

Module Type WRITEABLE_EXEC_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (MEM : MEMORY_MODEL_BASE ADDR SB)
  := EXEC_WRITEABLE_MEMORY_HELPER ADDR SB MEM.

Module Type WRITEABLE_EXEC_SPEC_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (MEM : MEMORY_MODEL_BASE ADDR SB)
  := WRITEABLE_MEMORY ADDR SB MEM <+ WRITEABLE_EXEC_MEMORY ADDR SB MEM.

Module Type WRITEABLE_CORRECT_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (MEM : MEMORY_MODEL_BASE ADDR SB)
  := WRITEABLE_EXEC_SPEC_MEMORY ADDR SB MEM <+ EXEC_MEMORY_WRITES_CORRECT ADDR SB MEM.
...
Module Type MEMORY_ALLOCATED_CORE
  ...
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import READ : CORE_MEMORY_MODEL_F ADDR SB MEM).
...
Module Type MEMORY_ALLOCATED_HELPER (ADDR : CORE_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (MEM : MEMORY_MODEL_BASE ADDR SB)
  := CORE_MEMORY_MODEL_F ADDR SB MEM <+ MEMORY_ALLOCATED_CORE ADDR SB AID MEM.

Module Type WRITEABLE_MEMORY_ALLOCATED_HELPER (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (MEM : MEMORY_MODEL_BASE ADDR SB)
  := WRITEABLE_MEMORY_HELPER ADDR SB MEM <+ MEMORY_ALLOCATED_CORE ADDR SB AID MEM.
...
Module Type WRITES_PRESERVES_ALLOCATED
  ...
  (Import AID : ALLOCATION_ID)
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import WRITE : WRITEABLE_MEMORY_ALLOCATED_HELPER ADDR SB AID MEM).

  Include (ALL_ALLOCATED_PRESERVED ADDR SB AID MEM WRITE).
...
Module Type EXEC_MEMORY_FIND_FREE_HELPER (ADDR : BASIC_ADDRESS) (SB : SBYTE) (MEM : MEMORY_MODEL_BASE ADDR SB)
  := CORE_EXEC_MEMORY_MODEL ADDR SB MEM <+ EXEC_MEMORY_FIND_FREE ADDR SB MEM.

Module Type EXEC_SPEC_MEMORY_FIND_FREE_HELPER (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (MEM : MEMORY_MODEL_BASE ADDR SB)
  := MEMORY_FIND_FREE_HELPER ADDR SB AID MEM <+ EXEC_MEMORY_FIND_FREE ADDR SB MEM.

Module Type EXEC_MEMORY_FIND_FREE_CORRECT
  (Import ADDR : BASIC_ADDRESS)
  (Import SB : SBYTE)
  (Import AID : ALLOCATION_ID)
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import EXEC_SPEC : EXEC_SPEC_MEMORY_FIND_FREE_HELPER ADDR SB AID MEM).

  Parameter find_free_block_correct :
    forall m n addrs,
      find_free_block_exec m n = NoOom addrs ->
      find_free_block m n addrs.
End EXEC_MEMORY_FIND_FREE_CORRECT.

Module Type CORRECT_MEMORY_FIND_FREE_HELPER (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (MEM : MEMORY_MODEL_BASE ADDR SB)
  := MEMORY_FIND_FREE_HELPER ADDR SB AID MEM <+ EXEC_MEMORY_FIND_FREE ADDR SB MEM <+ EXEC_MEMORY_FIND_FREE_CORRECT ADDR SB AID MEM.
...
Module Type MEMORY_ALLOCATE_HELPER
  ...
  := MEMORY_FIND_FREE_HELPER ADDR SB AID MEM <+ MEMORY_ALLOCATE ADDR SB AID MEM.

Module Type EXEC_MEMORY_ALLOCATE_HELPER
  (ADDR : BASIC_ADDRESS)
  (SB : SBYTE)
  (AID : ALLOCATION_ID)
  (MEM : MEMORY_MODEL_BASE ADDR SB)
  := EXEC_MEMORY_FIND_FREE_HELPER ADDR SB MEM <+ EXEC_MEMORY_ALLOCATE ADDR SB AID MEM.

Module Type EXEC_SPEC_MEMORY_ALLOCATE_HELPER
  (ADDR : BASIC_ADDRESS)
  (SB : SBYTE)
  (AID : ALLOCATION_ID)
  (MEM : MEMORY_MODEL_BASE ADDR SB)
  := MEMORY_ALLOCATE_HELPER ADDR SB AID MEM <+ EXEC_MEMORY_ALLOCATE ADDR SB AID MEM.
...
Module Type EXEC_MEMORY_ALLOCATE_CORRECT
  ...
  (Import AID : ALLOCATION_ID)
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import EXEC_SPEC : EXEC_SPEC_MEMORY_ALLOCATE_HELPER ADDR SB AID MEM).
...
Module Type CORRECT_MEMORY_ALLOCATE_HELPER
  (ADDR : BASIC_ADDRESS)
  (SB : SBYTE)
  (AID : ALLOCATION_ID)
  (MEM : MEMORY_MODEL_BASE ADDR SB)
  := EXEC_SPEC_MEMORY_ALLOCATE_HELPER ADDR SB AID MEM <+ EXEC_MEMORY_ALLOCATE_CORRECT ADDR SB AID MEM.

Module Type ALLOCATABLE_MEMORY_F (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (MEM : MEMORY_MODEL_BASE ADDR SB) :=
  WRITEABLE_MEMORY ADDR SB MEM <+ MEMORY_ALLOCATED_CORE ADDR SB AID MEM <+
    WRITES_PRESERVES_ALLOCATED ADDR SB AID MEM <+ MEMORY_FIND_FREE ADDR SB AID MEM <+
    MEMORY_ALLOCATE ADDR SB AID MEM.

Module Type ALLOCATABLE_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) :=
  MEMORY_MODEL_BASE ADDR SB <+ ALLOCATABLE_MEMORY_F ADDR SB AID.

Module Type EXEC_ALLOCATABLE_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (MEM : MEMORY_MODEL_BASE ADDR SB)
  := WRITEABLE_EXEC_MEMORY ADDR SB MEM <+
       EXEC_MEMORY_ALLOCATE ADDR SB AID MEM <+
       EXEC_MEMORY_FIND_FREE ADDR SB MEM.

Module Type EXEC_SPEC_ALLOCATABLE_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (MEM : MEMORY_MODEL_BASE ADDR SB)
  := ALLOCATABLE_MEMORY_F ADDR SB AID MEM <+ EXEC_ALLOCATABLE_MEMORY ADDR SB AID MEM.
...
Module Type MEMORY_STACK_ALLOCATE_HELPER
  (ADDR : BASIC_ADDRESS)
  (SB : SBYTE)
  (AID : ALLOCATION_ID)
  (F : FRAME ADDR)
  ...
  (MEM : MEMORY_MODEL_BASE ADDR SB)
  (MEMFS : MEMORY_FRAME_STACK ADDR SB F FS MEM)
  := ALLOCATABLE_MEMORY_F ADDR SB AID MEM <+ MEMORY_STACK_ALLOCATE ADDR SB AID F FS MEM MEMFS.

Module Type EXEC_MEMORY_STACK_ALLOCATE_HELPER
  (ADDR : BASIC_ADDRESS)
  (SB : SBYTE)
  (AID : ALLOCATION_ID)
  (F : FRAME ADDR)
  ...
  (MEM : MEMORY_MODEL_BASE ADDR SB)
  (MEMFS : MEMORY_FRAME_STACK ADDR SB F FS MEM)
  := EXEC_ALLOCATABLE_MEMORY ADDR SB AID MEM <+ EXEC_MEMORY_STACK_ALLOCATE ADDR SB AID F FS MEM MEMFS.

Module Type EXEC_SPEC_MEMORY_STACK_ALLOCATE_HELPER
  (ADDR : BASIC_ADDRESS)
  (SB : SBYTE)
  (AID : ALLOCATION_ID)
  (F : FRAME ADDR)
  ...
  (MEM : MEMORY_MODEL_BASE ADDR SB)
  (MEMFS : MEMORY_FRAME_STACK ADDR SB F FS MEM)
  := MEMORY_STACK_ALLOCATE_HELPER ADDR SB AID F FS MEM MEMFS <+
       EXEC_MEMORY_STACK_ALLOCATE_HELPER ADDR SB AID F FS MEM MEMFS.
...
Module Type EXEC_SPEC_MEMORY_STACK_ALLOCATE_HELPER'
  ...
  (MEMFS : MEMORY_FRAME_STACK ADDR SB F FS MEM)
  := MEMORY_STACK_ALLOCATE_HELPER ADDR SB AID F FS MEM MEMFS <+
       EXEC_MEMORY_STACK_ALLOCATE_HELPER ADDR SB AID F FS MEM MEMFS <+ EXEC_MEMORY_ALLOCATE_CORRECT ADDR SB AID MEM.
...
Module Type EXEC_MEMORY_STACK_ALLOCATE_CORRECT
  ...
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import MFS : MEMORY_FRAME_STACK ADDR SB F FS MEM)
  (Import EXEC_SPEC : EXEC_SPEC_MEMORY_STACK_ALLOCATE_HELPER' ADDR SB AID F FS MEM MFS).
...
Module Type CORRECT_MEMORY_STACK_ALLOCATE_HELPER
  (ADDR : BASIC_ADDRESS)
  (SB : SBYTE)
  (AID : ALLOCATION_ID)
  (F : FRAME ADDR)
  ...
  (MEM : MEMORY_MODEL_BASE ADDR SB)
  (MEMFS : MEMORY_FRAME_STACK ADDR SB F FS MEM)
  := EXEC_SPEC_MEMORY_STACK_ALLOCATE_HELPER' ADDR SB AID F FS MEM MEMFS <+
       EXEC_MEMORY_STACK_ALLOCATE_CORRECT ADDR SB AID F FS MEM MEMFS.
...
Module Type MEMORY_STACK_POP_BASE
  ...
  (* This should imply that allocations are preserved as well?
     Although... Maybe you can have something allocated but
     uninitialized that you cannot read...
   *)
...
Module Type EXEC_MEMORY_STACK_POP_BASE
  ...
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import MFS : MEMORY_FRAME_STACK ADDR SB F FS MEM)
  (Import FREE_BYTE : EXEC_MEMORY_FREE_BYTE ADDR SB MEM).
...
Module Type FULL_STACK_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (F : FRAME ADDR) (FS : FRAME_STACK ADDR F) (MEM : MEMORY_MODEL_BASE ADDR SB) (MEMFS : MEMORY_FRAME_STACK ADDR SB F FS MEM) :=
  ALLOCATABLE_MEMORY_F ADDR SB AID MEM <+ MEMORY_STACK_ALLOCATE ADDR SB AID F FS MEM MEMFS <+ MEMORY_STACK_POP_BASE ADDR SB AID F FS MEM MEMFS.

Module Type EXEC_FULL_STACK_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (F : FRAME ADDR) (FS : FRAME_STACK ADDR F) (MEM : MEMORY_MODEL_BASE ADDR SB) (MEMFS : MEMORY_FRAME_STACK ADDR SB F FS MEM) :=
  EXEC_ALLOCATABLE_MEMORY ADDR SB AID MEM <+ EXEC_MEMORY_FREE_BYTE ADDR SB MEM <+ EXEC_MEMORY_STACK_ALLOCATE ADDR SB AID F FS MEM MEMFS <+ EXEC_MEMORY_STACK_POP_BASE ADDR SB F FS MEM MEMFS.

Module Type EXEC_SPEC_FULL_STACK_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (F : FRAME ADDR) (FS : FRAME_STACK ADDR F) (MEM : MEMORY_MODEL_BASE ADDR SB) (MEMFS : MEMORY_FRAME_STACK ADDR SB F FS MEM) :=
  FULL_STACK_MEMORY ADDR SB AID F FS MEM MEMFS <+ EXEC_FULL_STACK_MEMORY ADDR SB AID F FS MEM MEMFS.
...
Module Type EXEC_MEMORY_STACK_POP_CORRECT
  ...
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import MFS : MEMORY_FRAME_STACK ADDR SB F FS MEM)
  (Import EXEC_SPEC : EXEC_SPEC_FULL_STACK_MEMORY ADDR SB AID F FS MEM MFS).
...
Module Type CORRECT_FULL_STACK_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (F : FRAME ADDR) (FS : FRAME_STACK ADDR F) (MEM : MEMORY_MODEL_BASE ADDR SB) (MEMFS : MEMORY_FRAME_STACK ADDR SB F FS MEM) :=
  EXEC_SPEC_FULL_STACK_MEMORY ADDR SB AID F FS MEM MEMFS <+ EXEC_MEMORY_STACK_POP_CORRECT ADDR SB AID F FS MEM MEMFS <+ EXEC_MEMORY_ALLOCATE_CORRECT ADDR SB AID MEM <+ EXEC_MEMORY_STACK_ALLOCATE_CORRECT ADDR SB AID F FS MEM MEMFS.
...
Module Type MEMORY_HEAP_ALLOCATE_HELPER (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (H : HEAP ADDR) (MEM : MEMORY_MODEL_BASE ADDR SB) (MH : MEMORY_HEAP ADDR SB H MEM) :=
  ALLOCATABLE_MEMORY_F ADDR SB AID MEM <+ MEMORY_HEAP_ALLOCATE ADDR SB AID H MEM MH.

Module Type EXEC_MEMORY_HEAP_ALLOCATE_HELPER (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (H : HEAP ADDR) (MEM : MEMORY_MODEL_BASE ADDR SB) (MH : MEMORY_HEAP ADDR SB H MEM) :=
  EXEC_ALLOCATABLE_MEMORY ADDR SB AID MEM <+ EXEC_MEMORY_HEAP_ALLOCATE ADDR SB AID H MEM MH.

Module Type EXEC_SPEC_MEMORY_HEAP_ALLOCATE (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (H : HEAP ADDR) (MEM : MEMORY_MODEL_BASE ADDR SB) (MH : MEMORY_HEAP ADDR SB H MEM) :=
  MEMORY_HEAP_ALLOCATE_HELPER ADDR SB AID H MEM MH <+ EXEC_MEMORY_HEAP_ALLOCATE_HELPER ADDR SB AID H MEM MH.

Module Type EXEC_SPEC_MEMORY_HEAP_ALLOCATE' (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID : ALLOCATION_ID) (H : HEAP ADDR) (MEM : MEMORY_MODEL_BASE ADDR SB) (MH : MEMORY_HEAP ADDR SB H MEM) :=
  MEMORY_HEAP_ALLOCATE_HELPER ADDR SB AID H MEM MH <+
    EXEC_MEMORY_HEAP_ALLOCATE_HELPER ADDR SB AID H MEM MH <+
    EXEC_MEMORY_ALLOCATE_CORRECT ADDR SB AID MEM.
...
Module Type EXEC_MEMORY_HEAP_ALLOCATE_CORRECT
  ...
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import MH : MEMORY_HEAP ADDR SB H MEM)
  (Import EXEC_SPEC : EXEC_SPEC_MEMORY_HEAP_ALLOCATE' ADDR SB AID H MEM MH).
...
Module Type EXEC_MEMORY_HEAP_FREE
  (Import ADDR : BASIC_ADDRESS)
  (Import SB : SBYTE)
  (Import H : HEAP ADDR)
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  ...
  Definition heap_free_exec (m : Memory) (ptr : addr) : option Memory
    := let h := Memory_heap m in
       (* Free pointers *)
       let m' := free_bytes_exec m (ptrs_in_heap h ptr) in
       h' <- free_root_in_heap h ptr;;
       ret (Memory_heap_modify m' (fun _ => h')).
End EXEC_MEMORY_HEAP_FREE.

Module Type FULL_HEAP_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID: ALLOCATION_ID) (H : HEAP ADDR) (MEM : MEMORY_MODEL_BASE ADDR SB) (MH : MEMORY_HEAP ADDR SB H MEM) :=
  ALLOCATABLE_MEMORY_F ADDR SB AID MEM <+ MEMORY_HEAP_ALLOCATE ADDR SB AID H MEM MH <+ MEMORY_HEAP_FREE ADDR SB AID H MEM MH.

Module Type EXEC_FULL_HEAP_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID: ALLOCATION_ID) (H : HEAP ADDR) (MEM : MEMORY_MODEL_BASE ADDR SB) (MH : MEMORY_HEAP ADDR SB H MEM) :=
  EXEC_ALLOCATABLE_MEMORY ADDR SB AID MEM <+ EXEC_MEMORY_HEAP_ALLOCATE ADDR SB AID H MEM MH <+ EXEC_MEMORY_FREE_BYTE ADDR SB MEM <+ EXEC_MEMORY_HEAP_FREE ADDR SB H MEM MH.

Module Type EXEC_SPEC_FULL_HEAP_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID: ALLOCATION_ID) (H : HEAP ADDR) (MEM : MEMORY_MODEL_BASE ADDR SB) (MH : MEMORY_HEAP ADDR SB H MEM) :=
  EXEC_SPEC_ALLOCATABLE_MEMORY ADDR SB AID MEM <+ EXEC_MEMORY_HEAP_ALLOCATE ADDR SB AID H MEM MH <+ EXEC_MEMORY_FREE_BYTE ADDR SB MEM <+ EXEC_MEMORY_HEAP_FREE ADDR SB H MEM MH <+ MEMORY_HEAP_ALLOCATE ADDR SB AID H MEM MH <+ MEMORY_HEAP_FREE ADDR SB AID H MEM MH.

Module Type EXEC_MEMORY_HEAP_FREE_CORRECT
  (Import ADDR : BASIC_ADDRESS)
  (Import SB : SBYTE)
  (Import AID : ALLOCATION_ID)
  (Import H : HEAP ADDR)
  (Import MEM : MEMORY_MODEL_BASE ADDR SB)
  (Import MH : MEMORY_HEAP ADDR SB H MEM)
  (Import EXEC_SPEC : EXEC_SPEC_FULL_HEAP_MEMORY ADDR SB AID H MEM MH).

  Parameter heap_free_correct :
    forall m ptr m',
      heap_free_exec m ptr = Some m' ->
      heap_free m ptr m'.
End EXEC_MEMORY_HEAP_FREE_CORRECT.

Module Type CORRECT_FULL_HEAP_MEMORY (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID: ALLOCATION_ID) (H : HEAP ADDR) (MEM : MEMORY_MODEL_BASE ADDR SB) (MH : MEMORY_HEAP ADDR SB H MEM)
  := EXEC_SPEC_FULL_HEAP_MEMORY ADDR SB AID H MEM MH <+ EXEC_MEMORY_HEAP_FREE_CORRECT ADDR SB AID H MEM MH <+ EXEC_MEMORY_ALLOCATE_CORRECT ADDR SB AID MEM <+ EXEC_MEMORY_HEAP_ALLOCATE_CORRECT ADDR SB AID H MEM MH.

(** Memory with reads, writes, stack allocations, and heap allocations *)
Module Type FULL_MEMORY_MODEL' (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID: ALLOCATION_ID) (H : HEAP ADDR) (F : FRAME ADDR) (FS : FRAME_STACK ADDR F) (MEM : MEMORY_MODEL_BASE ADDR SB) (MH : MEMORY_HEAP ADDR SB H MEM) (MFS : MEMORY_FRAME_STACK ADDR SB F FS MEM)
  := ALLOCATABLE_MEMORY_F ADDR SB AID MEM <+
       MEMORY_STACK_ALLOCATE ADDR SB AID F FS MEM MFS <+
       MEMORY_STACK_POP_BASE ADDR SB AID F FS MEM MFS <+
       MEMORY_HEAP_ALLOCATE ADDR SB AID H MEM MH <+
       MEMORY_HEAP_FREE ADDR SB AID H MEM MH.

(** Executable memory with reads, writes, stack allocations, and heap allocations *)
Module Type FULL_EXEC_MEMORY_MODEL' (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID: ALLOCATION_ID) (H : HEAP ADDR) (F : FRAME ADDR) (FS : FRAME_STACK ADDR F) (MEM : MEMORY_MODEL_BASE ADDR SB) (MH : MEMORY_HEAP ADDR SB H MEM) (MFS : MEMORY_FRAME_STACK ADDR SB F FS MEM)
  := EXEC_ALLOCATABLE_MEMORY ADDR SB AID MEM <+
       EXEC_MEMORY_FREE_BYTE ADDR SB MEM <+
       EXEC_MEMORY_STACK_ALLOCATE ADDR SB AID F FS MEM MFS <+
       EXEC_MEMORY_STACK_POP_BASE ADDR SB F FS MEM MFS<+
       EXEC_MEMORY_HEAP_ALLOCATE ADDR SB AID H MEM MH <+
       EXEC_MEMORY_HEAP_FREE ADDR SB H MEM MH.

(** Correct executable memory with reads, writes, stack allocations, and heap allocations *)
Module Type FULL_CORRECT_MEMORY_MODEL' (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID: ALLOCATION_ID) (H : HEAP ADDR) (F : FRAME ADDR) (FS : FRAME_STACK ADDR F) (MEM : MEMORY_MODEL_BASE ADDR SB) (MH : MEMORY_HEAP ADDR SB H MEM) (MFS : MEMORY_FRAME_STACK ADDR SB F FS MEM)
  := FULL_MEMORY_MODEL' ADDR SB AID H F FS MEM MH MFS <+
       FULL_EXEC_MEMORY_MODEL' ADDR SB AID H F FS MEM MH MFS <+
       CORE_EXEC_MEMORY_MODEL_CORRECT ADDR SB MEM <+
       EXEC_MEMORY_WRITES_CORRECT ADDR SB MEM <+
       EXEC_MEMORY_FIND_FREE_CORRECT ADDR SB AID MEM <+
       EXEC_MEMORY_ALLOCATE_CORRECT ADDR SB AID MEM <+
...
(*** Full Memory Modules with freshness included *)
Module Type FULL_MEMORY_MODEL (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID: ALLOCATION_ID) (H : HEAP ADDR) (F : FRAME ADDR) (FS : FRAME_STACK ADDR F)
  := MEMORY_MODEL_BASE ADDR SB <+ MEMORY_HEAP ADDR SB H <+ MEMORY_FRAME_STACK ADDR SB F FS <+
       ...
       FULL_MEMORY_MODEL' ADDR SB AID H F FS.

Module Type FULL_EXEC_MEMORY_MODEL (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID: ALLOCATION_ID) (H : HEAP ADDR) (F : FRAME ADDR) (FS : FRAME_STACK ADDR F)
  := MEMORY_MODEL_BASE ADDR SB <+ MEMORY_HEAP ADDR SB H <+ MEMORY_FRAME_STACK ADDR SB F FS <+
       CORE_MEMORY_FRESH_AID ADDR SB AID <+ CORE_MEMORY_FRESH_STORE_ID ADDR SB <+
       FULL_EXEC_MEMORY_MODEL' ADDR SB AID H F FS.

Module Type FULL_CORRECT_MEMORY_MODEL (ADDR : BASIC_ADDRESS) (SB : SBYTE) (AID: ALLOCATION_ID) (H : HEAP ADDR) (F : FRAME ADDR) (FS : FRAME_STACK ADDR F)
  := MEMORY_MODEL_BASE ADDR SB <+ MEMORY_HEAP ADDR SB H <+ MEMORY_FRAME_STACK ADDR SB F FS <+
       CORE_MEMORY_FRESH_AID ADDR SB AID <+ CORE_MEMORY_FRESH_STORE_ID ADDR SB <+
