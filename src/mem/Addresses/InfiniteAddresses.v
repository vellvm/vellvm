...
Module Type Inf_HAS_PROVENANCE <: HAS_PROVENANCE N_ProvSet InfAddrType.
  Definition address_provenance := fun (ptr : InfAddrType.t) => snd ptr.
End Inf_HAS_PROVENANCE.

Module InfAddr <: ADDRESS := InfAddrType <+ InfNull <+ InfPTOI <+ Inf_HAS_POINTER_ARITHMETIC_CORE <+ HAS_POINTER_ARITHMETIC_HELPERS <+ Inf_HAS_PROVENANCE.
...
Module InfAddr : MemoryAddress.INFINITE_ADDRESS
with Definition t := (Iptr * Prov) % type
