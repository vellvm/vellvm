...
let camlint_of_coqint : Integers.bit_int -> int32 = Z.to_int32
let coqint_of_camlint : int32 -> Integers.bit_int = Z.of_uint32
   (* interpret the int32 as unsigned so that result Z is in range for int *)
let camlint64_of_coqint : Integers.bit_int -> int64 = Z.to_int64
let coqint_of_camlint64 : int64 -> Integers.bit_int = Z.of_uint64
