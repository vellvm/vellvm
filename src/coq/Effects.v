...
| Alloca : forall (t:typ), (IO value)
(* OPTION 1: *)
| Load   : forall (t:typ) (a:addr), (IO value)
(* OPTION 2: *)
(* | Load   : forall (t:typ) (a:value), (IO (err value)) *)
| Store  : forall (a:addr) (v:value), (IO unit)
| GEP    : forall (t:typ) (v:addr) (vs:list value), (IO value)
| ItoP   : forall (t:typ) (i:ptr_int_type), (IO value)
| PtoI   : forall (t:typ) (a:addr), (IO value)
| Call   : forall (t:typ) (f:string) (args:list value), (IO value)
| DeclareFun : forall (f:string), (IO value)
.    
