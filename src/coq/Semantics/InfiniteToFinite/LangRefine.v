...
Module Type LangRefine (IS1 : InterpreterStack) (IS2 : InterpreterStack) (AC1 : AddrConvert IS1.LP.ADDR IS1.LP.PTOI IS2.LP.ADDR IS2.LP.PTOI) (AC2 : AddrConvert IS2.LP.ADDR IS2.LP.PTOI IS1.LP.ADDR IS1.LP.PTOI) (LLVM1 : LLVMTopLevel IS1) (LLVM2 : LLVMTopLevel IS2) (TLR : TopLevelRefinements IS2 LLVM2) (IPS : IPConvertSafe IS2.LP.IP IS1.LP.IP) (ACS : AddrConvertSafe IS2.LP.ADDR IS2.LP.PTOI IS1.LP.ADDR IS1.LP.PTOI AC2 AC1) (DVC : DVConvert IS1.LP IS2.LP AC1 IS1.LP.Events IS2.LP.Events) (DVCrev : DVConvert IS2.LP IS1.LP AC2 IS2.LP.Events IS1.LP.Events) (EC : EventConvert IS1.LP IS2.LP AC1 AC2 IS1.LP.Events IS2.LP.Events DVC DVCrev) (TC : TreeConvert IS1 IS2 AC1 AC2 DVC DVCrev EC).
  ...
  *)
  ...
  Lemma eval_fcmp_fin_inf :
    forall dv1_fin dv2_fin res_fin fcmp dv1_inf dv2_inf,
      ...
      @IS1.LP.Events.DV.eval_fcmp err_ub_oom
        (@Monad_err_ub_oom IdentityMonad.ident IdentityMonad.Monad_ident)
        (@RAISE_ERROR_err_ub_oom IdentityMonad.ident IdentityMonad.Monad_ident)
        fcmp dv1_inf dv2_inf = ret (lift_dvalue_fin_inf res_fin).
  Proof.
  ...
  Lemma lift_dvalue_fin_inf_i1 :
    forall x,
      lift_dvalue_fin_inf (DVALUE_I1 x) =
  ...
  Lemma lift_dvalue_fin_inf_i8 :
    forall x,
      lift_dvalue_fin_inf (DVALUE_I8 x) =
  ...
  Lemma lift_dvalue_fin_inf_iptr :
    forall x,
      lift_dvalue_fin_inf (DVALUE_IPTR x) =
  ...
  Ltac rewrite_lift_dvalue_fin_inf :=
    repeat
      first
      [ rewrite lift_dvalue_fin_inf_i1
      | rewrite lift_dvalue_fin_inf_i8
  ...
  Proof.
    ...
    - cbn in *.
      ...
      { (* Structs *)
        cbn; rewrite_lift_dvalue_fin_inf.
        break_match_hyp_inv.
        rewrite H0.
      ...
      { (* Arrays iptr *)
        cbn in *; rewrite_lift_dvalue_fin_inf.
        rewrite H1.
        erewrite IHidxs_fin; eauto.
  ...
  Proof.
    ...
    - cbn in *; subst; cbn.
      break_match_hyp_inv; rewrite_lift_dvalue_fin_inf;
        break_match_hyp_inv;
        rewrite sizeof_dtyp_fin_inf;
  ...
  Lemma eval_select_fin_inf :
    forall cond uv1_fin uv2_fin uv1_inf uv2_inf res,
      ...
      @eval_select ErrUbOomProp Monad_ErrUbOomProp
        ...
        (@RAISE_UB_err_ub_oom_T IdentityMonad.ident IdentityMonad.Monad_ident)
        (@RAISE_OOM_err_ub_oom_T IdentityMonad.ident IdentityMonad.Monad_ident)
        (fun (A : Type) (x ue : err_ub_oom A) => x = ue) cond uv1_fin uv2_fin res ->
      @IS1.MEM.CP.CONC.eval_select ErrUbOomProp Monad_ErrUbOomProp
        ...
        (@RAISE_UB_err_ub_oom_T IdentityMonad.ident IdentityMonad.Monad_ident)
        (@RAISE_OOM_err_ub_oom_T IdentityMonad.ident IdentityMonad.Monad_ident)
        (fun (A : Type) (x ue : err_ub_oom A) => x = ue) (lift_dvalue_fin_inf cond) uv1_inf uv2_inf (fmap lift_dvalue_fin_inf res).
  Proof.
    intros cond uv1_fin uv2_fin uv1_inf uv2_inf res REF1 REF2 EVAL.
    destruct cond.
    ...
    { (* Vectors *)
      rewrite lift_dvalue_fin_inf_vector.
      assert ((exists elts1_fin, IS2.MEM.CP.CONC.concretize uv1_fin (DVALUE_Vector elts1_fin)) \/
                forall elts1_fin, ~ IS2.MEM.CP.CONC.concretize uv1_fin (DVALUE_Vector elts1_fin)).
      { admit.
      }
      destruct H as [[elts1_fin VEC1] | NVEC1].

      { assert ((exists elts2_fin, IS2.MEM.CP.CONC.concretize uv2_fin (DVALUE_Vector elts2_fin)) \/
                  forall elts2_fin, ~ IS2.MEM.CP.CONC.concretize uv2_fin (DVALUE_Vector elts2_fin)).
        { admit.
        }
        destruct H as [[elts2_fin VEC2] | NVEC2].

        { unfold eval_select in EVAL.
          rewrite IS2.MEM.CP.CONC.concretize_equation in VEC1, VEC2.
          red in VEC1, VEC2.
          (* Why can't I do these rewrites? *)
          admit.
        }
  ...
  Proof.
    ...
    - (* Struct *)
      ...
      repeat red.
      exists (ret (map lift_dvalue_fin_inf x1)).
    ...
    - (* GetElementPtr *)
      ...
      { clear - H H1 Heqo0.
        ...
        - forward IHHeqo0.
          ...
          exists (ret (lift_dvalue_fin_inf x2)).
          exists (fun dv_inf => fmap (fmap lift_dvalue_fin_inf) (x1 x2)).
          ...
          intros a ?; subst.
          repeat red.
          exists (ret (fmap lift_dvalue_fin_inf x5)).
          exists (fun dv_inf => (fmap (fmap lift_dvalue_fin_inf) (x4 x5))).
      ...
      replace (map lift_dvalue_fin_inf x3) with (fmap lift_dvalue_fin_inf x3) in H4 by reflexivity.
      cbn in H4.
      rewrite H4.
    ...
    - (* Select *)
      ...
      pose proof eval_select_fin_inf x1 u0 u1 _ _ (x0 x1) Heqo0 Heqo1 H1 as EVAL.
      ...
      exists (fun dv_inf => (fmap lift_dvalue_fin_inf (x0 x1))).
      split; eauto.
      split; cbn; rewrite H3; cbn; eauto.
  ...
  (*   { (* IBinop *) *)
  (*     destruct IHuv1 as [CONCuv1 | NCONCuv1]. *)
  (*     2: { *)
  (*       right. *)
  (*       intros dv CONC. *)
  (*       rewrite concretize_equation in CONC; *)
  ...
  (*     destruct IHuv2 as [CONCuv2 | NCONCuv2]. *)
  (*     2: { *)
  (*       right. *)
  (*       intros dv CONC. *)
  (*       rewrite concretize_equation in CONC; *)
  ...
  (*     (* Ugh. There may be multiple concretizations for uv1 / uv2... *)

  (*        It's  *)

  (*        Which means that this isn't inductively stable... *)
  (*      *) *)
  (*     destruct CONCuv1 as (dv1 & CONCuv1). *)
  (*     destruct CONCuv2 as (dv2 & CONCuv2). *)
  (*     (* TODO: May need to do these destructs before picking a side... *) *)


  (*     remember (@eval_iop err_ub_oom _ _ _ _ iop dv1 dv2) as res. *)
  ...
  Proof.
    ...
    { (* Structs *)
      ...
      revert x0 x1 H0 H2.
      induction Heqo; intros x0 x1 FIELDS X0X1.
      - inv FIELDS; inv X0X1.
        eapply FAILS.
        ...
        exists (ret []).
        exists (fun elts => ret (IS1.LP.Events.DV.DVALUE_Struct elts)).
      ...
      - forward IHHeqo.
        ...
        (* I know UVALUE_Struct (x :: l) fails to concretize...

           This may mean that x fails to concretize, and
           UVALUE_Struct l would successfully concretize.

           But if x does concretize, then UVALUE_Struct l must fail to
           concretize.
         *)

        pose proof classic (exists dv, IS1.LLVM.MEM.CP.CONC.concretize x dv)
          as [[dvx CONCx] | NCONCx].
        { forward IHHeqo.
          { intros dv CONC.
          ...
          inv FIELDS.
          specialize (IHHeqo (fun l => ret (DVALUE_Struct l))).
          eapply IHHeqo in H5; auto.
        }

        (* x does not concretize... *)
        inv FIELDS.

        eapply H.
        left; reflexivity.
        rewrite uvalue_refine_strict_equation; eauto.
    ...
    { (* Packed_Structs *)
      ...
      - forward IHHeqo.
        ...
        (* I know UVALUE_Packed_struct (x :: l) fails to concretize...

           This may mean that x fails to concretize, and
           UVALUE_Packed_struct l would successfully concretize.

           But if x does concretize, then UVALUE_Packed_struct l must fail to
           concretize.
         *)
        ...
        { forward IHHeqo.
          ...
          inv FIELDS.
          specialize (IHHeqo (fun l => ret (DVALUE_Packed_struct l))).
          eapply IHHeqo in H5; auto.
        }
    ...
    { (* Arrays *)
      ...
      - inv FIELDS; inv X0X1.
        ...
        exists (ret []).
        exists (fun elts => ret (IS1.LP.Events.DV.DVALUE_Array elts)).
      ...
      - forward IHHeqo.
        ...
        { forward IHHeqo.
          ...
          inv FIELDS.
          specialize (IHHeqo (fun l => ret (DVALUE_Array l))).
          eapply IHHeqo in H5; auto.
        }
    ...
    { (* Vectors *)
      ...
      - forward IHHeqo.
        ...
        { forward IHHeqo.
          ...
          inv FIELDS.
          specialize (IHHeqo (fun l => ret (DVALUE_Vector l))).
          eapply IHHeqo in H5; auto.
        }
    ...
    { (* FBinop *)
      ...
      pose proof (eval_fop_fin_inf _ _ _ _ _ _ H2 eq_refl eq_refl) as EVAL.
      ...
      exists (ret (lift_dvalue_fin_inf x1)).
      exists (fun _ => IS1.LP.Events.DV.eval_fop fop (lift_dvalue_fin_inf x1) (lift_dvalue_fin_inf x3)).
    ...
    { (* Conversion *)
      ...
      break_match_hyp;
        try (cbn in H1; rewrite <- H1 in H3; inv H3).
      { (* Pure conversion *)
        eapply FAILS.
        ...
        exists (ret (lift_dvalue_fin_inf x1)).
        exists (fun _ => ret (lift_dvalue_fin_inf dv)).
        ...
        erewrite get_conv_case_pure_fin_inf; cbn; eauto.
      }
    ...
    { (* GetElementPtr *)
      ...
      remember (x2 x3) as x2x3.
      destruct_err_ub_oom x2x3; inv H6.
      cbn in H2.

      break_match_hyp; try inv H3.
      break_match_hyp_inv.

      apply map_monad_InT_oom_forall2 in Heqo0.
      apply Forall2_Forall2_HInT in Heqo0.
      apply map_monad_ErrUbOomProp_forall2 in H1.

      revert x0 x1 H0 x2 x3 H1 Heqs H2 Heqx2x3.
      induction Heqo0; intros x0 x1 H0' x2 x3 H1 Heqs H2 Heqx2x3.
      - inv H1.
        unfold GEP.handle_gep in Heqs.
        repeat break_match_hyp_inv.
      - inv H1.
        forward IHHeqo0.
    ...
    { (* ExtractElement *)
      ...
      exists (ret (lift_dvalue_fin_inf x1)).
      exists (fun _ => IS1.LP.Events.DV.index_into_vec_dv x5 (lift_dvalue_fin_inf x1) (lift_dvalue_fin_inf x3)).
    ...
    { (* ExtractValue *)
      ...
      pose proof (uvalue_concretize_strict_concretize_inclusion _ _ Heqo _ H) as UV1.
      ...
      - rewrite <- H1 in H3; inv H3.
        ...
        exists (ret (lift_dvalue_fin_inf dv)).
        exists (fun _ => ret (lift_dvalue_fin_inf dv)).
        ...
        reflexivity.
      - cbn in H1.
        remember (index_into_str_dv x1 a) as ind_into_str.
        destruct_err_ub_oom ind_into_str;
          cbn in H1; rewrite <- H1 in H3; inv H3.
    ...
    { (* InsertValue *)
      ...
      remember (x2 x3) as x2x3.
      destruct_err_ub_oom x2x3; inv H5; inv H4.
