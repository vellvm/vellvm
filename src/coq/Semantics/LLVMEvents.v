...
Module Type LLVM_INTERACTIONS (ADDR : NULLABLE_ADDRESS) (IP:INTPTR) (SIZEOF : Sizeof).
...
Module Make (ADDR : NULLABLE_ADDRESS) (IP:INTPTR) (SIZEOF : Sizeof) <: LLVM_INTERACTIONS ADDR IP SIZEOF.
