...
Definition float_ast := Floats.float.  (* 64-bit floating point value *)
Definition float32_ast := Floats.float32.
...
| EXP_Float   (f:float32_ast)  (* 32-bit floating point values *)
| EXP_Double  (f:float_ast)    (* 64-bit floating point values *)
| EXP_Hex     (f:float_ast)    (* See LLVM documentation about hex float constants. *)
| EXP_Bool    (b:bool)
| EXP_Null
