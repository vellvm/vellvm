...
Definition MemPropT (MemState : Type) (X : Type) : Type
  := MemState -> EOB (MemState * X)%type -> Prop.
...
Proof.
  ...
  intros A m1 m2.
  unfold MemPropT in *.
  exact (forall (ms : MemState) (x : EOB (MemState * A)),
            m1 ms x <-> m2 ms x).
Defined.
...
Proof.
  ...
  - intros A B f x.
    ...
    +
      ...
      destruct x0; firstorder; subst; firstorder.
      repeat break_match_hyp.
      destruct M as (sab & a & (EQ1 & EQ2) & F); subst.
      auto.
    + destruct x0; firstorder.
      destruct x0. exists ms. exists x. firstorder.
  - intros A x.
    cbn.
    unfold eq1, MemPropT_Eq1 in *.
    split;
    ...
    + destruct x0; firstorder; subst; firstorder.
      ...
      auto.
    + destruct x0; firstorder.
      destruct x0. exists m. exists a. firstorder.
  - intros A B C x f g.
    cbn.
    unfold eq1, MemPropT_Eq1 in *.
    split;
      intros M.
    + destruct x0; firstorder; subst; firstorder.
      * right. exists x2. exists x3. firstorder.
      * right. exists x2. exists x3. firstorder.
      * right. exists x2. exists x3. firstorder.
      * destruct x0.
  ...
  - repeat red. intros.
    split; cbn; intros.
    + destruct x1; firstorder; subst; firstorder.
      * right. exists x1. exists x2. split. apply H. assumption. apply H0. assumption.
      * right. exists x1. exists x2. split. apply H. assumption. apply H0. assumption.
      * right. exists x1. exists x2. split. apply H. assumption. apply H0. assumption.
      * destruct x1.
