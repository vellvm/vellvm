...
Section LABELS_THEORY.
  ...
  Proof using.
    intros.
    red; rewrite inputs_app; apply Rocqlib.list_norepet_append_commut; rewrite <- inputs_app; apply H.
  Qed.
  ...
  Proof using.
    intros; eauto using Rocqlib.list_disjoint_notin.
  Qed.
  ...
  Proof using.
    intros; eauto using Rocqlib.list_disjoint_notin, Rocqlib.list_disjoint_sym.
  Qed.
