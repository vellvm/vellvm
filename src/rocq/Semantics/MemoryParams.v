...
Module Type MemoryParams (LP : LLVMParams).
  ...
  Declare Module BYTE_IMPL : ByteModule LP.ADDR LP.IP LP.SIZEOF LP.Events.
  Declare Module DVALUE_BYTES : DvalueByte LP.
End MemoryParams.

Module Make (LP' : LLVMParams) (GEP' : GEPM LP'.ADDR LP'.IP LP'.SIZEOF LP'.Events) (BYTE_IMPL' : ByteModule LP'.ADDR LP'.IP LP'.SIZEOF LP'.Events) (DVALUE_BYTES' : DvalueByte LP') : MemoryParams LP'
with Module GEP := GEP'
