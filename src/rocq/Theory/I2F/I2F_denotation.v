...
Lemma I2F_denote_instr :
  ...
  Proof with try now (rstep; cbnn; try (easy); eauto).
    ...
    - destruct val,ptr, x; cbn...
      ...
      induction H0...
      induction H0...
      (* [I2F_dvalue_Poison], 7th constructor of [I2F_dvalue_base] *)
      7: rbind (fun _ _ => False); [|intros _ _ []]...
    ...
    - destruct x; cbn...
      ...
      { cbn; inv H0; [inv H2 | |]...
        (* [inv H2] fans out over the 9 constructors of [I2F_dvalue_base], plus
           the [Struct]/[Array] goals: every one but the integer case (goal 2)
           is an error branch. *)
