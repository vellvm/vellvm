...
define i64 @testVectorToi64(<2 x i32> %V) {
  %V = add <2 x i32> <i32 0, i32 0>, zeroinitializer
  %returnVal = bitcast <2 x i32> %V to i64
  ret i64 %returnVal
}
...
; ASSERT EQ: i32 0 = call i32 @testPointerCast(i32 0) ;; Unsure on why this does not work

; ASSERT EQ: i64 0 = call i64 @testVectorToi64() ;; this may depend on endianess, but I'm unsure of why the 0 case doesn't work.
