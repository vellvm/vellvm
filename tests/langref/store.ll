; Examples from the LLVM LangRef's 'store' Instruction section.
; langref: store-instruction sha1=d4a734206c9874fb15a4eb97ef8d89a06e836df9
;
...
; ASSERT EQ: i32 8 = call i32 @store_twice()
