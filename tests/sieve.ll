...
define i64 @is_prime(i64 %n) {
  ...
  %1 = getelementptr i64* %sieve, i64 0
  store i64 0, i64* %1
  %2 = getelementptr i64* %sieve, i64 1
  store i64 0, i64* %2
  br label %start1
...
loop1:
  %5 = load i64* %i
  %6 = getelementptr i64* %sieve, i64 %5 
  store i64 1, i64* %6
  %7 = add i64 %5, 1
  store i64 %7, i64* %i
  br label %cmp1
...
loop2:
  %10 = load i64* %i
  %11 = getelementptr i64* %sieve, i64 %10
  %12 = load i64* %11
  %13 = icmp eq i64 %12, 1
...
loop3:
  %17 = getelementptr i64* %sieve, i64 %15
  store i64 0, i64* %17
  %18 = add i64 %15, %10
  store i64 %18, i64* %j
  br label %cmp3
...
end2:
  %ptr = getelementptr i64* %sieve, i64 %n
  %r = load i64* %ptr
  ret i64 %r 
}
