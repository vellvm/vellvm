...
- [[file:src/coq/Semantics/MemoryAddress.v::(* -------------------------------------------------------------------------- *][MemoryAddress.v]]
  + Contains module types for addresses, provenance, and integer / pointer casting.
- [[file:src/coq/Semantics/Memory/Overlaps.v::Require Import ZArith.][Overlaps.v]]
  + Notion of addresses overlapping in memory.
- [[file:src/coq/Semantics/Memory/Sizeof.v::From Coq Require Import][Sizeof.v]]
...
- [[file:src/coq/Semantics/Memory/MemBytes.v::From Coq Require Import String List ZArith.][src/coq/Semantics/Memory/MemBytes.v]]
  + Symbolic byte modules.

Concretization files:

- [[file:src/coq/Handlers/Concretization.v::From Vellvm Require Import][src/coq/Handlers/Concretization.v]]
- [[file:src/coq/Handlers/Pick.v::begin hide *][src/coq/Handlers/Pick.v]]

*** Other Relevant Files

- [[file:src/coq/Semantics/DynamicValues.v::begin hide *][src/coq/Semantics/DynamicValues.v]]
  + Definition of LLVM values
- [[file:src/coq/Semantics/LLVMEvents.v::From Coq Require Import][src/coq/Semantics/LLVMEvents.v]]
...
events. These events are handled in [[file:src/coq/Handlers/Pick.v::From Coq Require Import][src/coq/Handlers/Pick.v]]. There are two versions of the pick handler:
