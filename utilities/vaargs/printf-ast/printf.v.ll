...
define  i32 @printf_(i8* noundef %0, ...) {
1:
    %2 = alloca i8*, align 8
    %3 = alloca i8*, align 8
...
define  i32 @sprintf_(i8* noundef %0, i8* noundef %1, ...) {
2:
    %3 = alloca i8*, align 8
    %4 = alloca i8*, align 8
    %5 = alloca i8*, align 8
...
define  i32 @snprintf_(i8* noundef %0, i64 noundef %1, i8* noundef %2, ...) {
3:
    %4 = alloca i8*, align 8
...
define  i32 @vprintf_(i8* noundef %0, i8* noundef %1) {
2:
    %3 = alloca i8*, align 8
    %4 = alloca i8*, align 8
...
define  i32 @vsnprintf_(i8* noundef %0, i64 noundef %1, i8* noundef %2, i8* noundef %3) {
4:
    %5 = alloca i8*, align 8
...
declare  void @_putchar(i8 noundef)
